...
class RefreshFooterView: RefreshBaseView {
    class func footer()->RefreshFooterView{
        let footer:RefreshFooterView  = RefreshFooterView(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.width, RefreshViewHeight))
        return footer
    }
    ...
    func  totalDataCountInScrollView()->Int
    {
        ...
        if self.scrollView is UITableView {
            ...
            for (var i:Int = 0 ; i <  tableView.numberOfSections ; i += 1){
